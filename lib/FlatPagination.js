...
var FlatPagination = function (_React$PureComponent) {
  ...
  _createClass(FlatPagination, [{
    ...
    key: 'renderButton',
    value: function renderButton(label, targetPage, position) {
      var _this2 = this;
    ...
    value: function render() {
      ...
      return _react2.default.createElement(
        ...
        leftLabels.map(function (label) {
          return _this3.renderButton(label, targetPage(label), 'left');
        }),
        this.renderButton(currentLabel, targetPage(currentLabel), 'current'),
        rightLabels.map(function (label) {
          return _this3.renderButton(label, targetPage(label), 'right');
        }),
