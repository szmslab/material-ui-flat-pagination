...
var FlatPagination = function (_React$PureComponent) {
  ...
  _createClass(FlatPagination, [{
    key: 'handleClick',
    value: function handleClick(e, targetPage) {
      ...
      if (position === 'previous' || position === 'next') {
        ...
        if (_react2.default.isValidElement(label)) {
          icon = _react2.default.cloneElement(label, {
            style: _extends({}, _styles.labelStyle, label.props.style)
          });
        }
        return _react2.default.createElement(_FlatButton2.default, _extends({
          ...
          labelStyle: _extends({}, _styles.labelStyle, otherPageLabelStyle),
          hoverColor: hoverColor,
          onClick: function onClick(e) {
            return _this2.handleClick(e, targetPage);
          },
          rippleColor: rippleColor,
          style: _extends({}, _styles.buttonStyle, otherPageStyle)
        }));
        ...
        return _react2.default.createElement(_FlatButton2.default, {
          ...
          disableTouchRipple: disableTouchRipple,
          labelStyle: _extends({}, isEllipsis ? _styles.ellipsisLabelStyle : _styles.labelStyle, otherPageLabelStyle),
          hoverColor: hoverColor,
          onClick: function onClick(e) {
            return _this2.handleClick(e, targetPage);
          },
        ...
        return _react2.default.createElement(_FlatButton2.default, {
          ...
          labelStyle: _extends({}, _styles.labelStyle, currentPageLabelStyle),
          hoverColor: hoverColor,
          style: _extends({}, _styles.buttonStyle, currentPageStyle)
        });
      }
    }
  }, {
